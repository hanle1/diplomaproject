...
export default class Avatar extends Component {
    ...
    render() {
        var svgStyle = {
            fill:'#337ab7', color:'#fff', position: 'absolute', top: '0', border: '0', right: '0'
        }
        var pathStyle = {
